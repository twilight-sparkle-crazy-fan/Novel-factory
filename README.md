...
在“创作设置”中导出的 Markdown 会包含当前已选下一章大纲；完整 JSON 备份也会带上最新大纲及其候选版本，并可重新导入为一条新的恢复对话。
